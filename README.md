...
<head>
  ...
  <style>
    ...
    /* Flores dispersas por la invitación */
    body::before, body::after {
      content: "";
      position: fixed;
      width: 100px;
      height: 100px;
      background: url('https://static.vecteezy.com/system/resources/thumbnails/009/597/218/small_2x/rose-flower-and-botanical-leaf-digital-painted-png.png') no-repeat center center/contain;
      opacity: 0.15;
      pointer-events: none;
      z-index: 0;
    }
